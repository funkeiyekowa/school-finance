...
export type LimiterName = "sms-webhook" | "email-webhook" | "alert-test" | "ai-generate" | "ai-test" | "client-error" | "lms-study-help" | "lms-practice" | "ai-assistant" | "ai-ask" | "photos-upload" | "storage-upload" | "proctoring-upload-url";
