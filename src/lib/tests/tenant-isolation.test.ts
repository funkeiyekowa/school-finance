...
console.log("");
console.log("An EXECUTABLE counterpart now exists: npm run test:db");
console.log("(src/lib/tests/db/tenant-isolation.db.test.ts) signs real users in");
console.log("and asserts RLS behaviour. This file remains the specification.");
