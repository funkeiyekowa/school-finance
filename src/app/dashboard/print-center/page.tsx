...
const ENTRIES: Entry[] = [
  ...
  { group: "Finance & Payments",
    ...
    blurb: "Board-friendly summary — per grade: students, total due, collected, outstanding, collection %.",
    href: "/dashboard/student-finance/class-report",
    icon: <Wallet size={16} /> },
  { group: "Finance & Payments",
  ...
  { group: "Finance & Payments",
    title: "Receipts (batch)",
    blurb: "One-click batch print of every filtered receipt on letterhead — one page per receipt.",
    href: "/dashboard/receipts",
    needs: "Filter → Print batch",
    icon: <Receipt size={16} /> },
  { group: "Finance & Payments",
    title: "Payment voucher (per expense)",
    blurb: "Formal payment voucher with amount in figures + words and preparer / approver / receiver signatures.",
    href: "/dashboard/expenses",
    needs: "Row → printer icon",
    icon: <Receipt size={16} /> },
  { group: "Finance & Payments",
  ...
  { group: "Students & Parents",
    ...
    blurb: "2-up A4 grid of ID cards with monogram, class, admission number, guardian phone.",
    href: "/dashboard/students/id-cards",
    needs: "Filter by grade first for a class batch",
    icon: <IdCard size={16} /> },
  { group: "Staff",
    title: "Staff directory",
    blurb: "Printable staff phone/email list grouped by department — front-office / termly-meeting handout.",
  ...
  { group: "Finance & Payments",
    ...
    blurb: "Maintenance history + upcoming schedule for every non-disposed asset.",
    href: "/dashboard/assets/maintenance-report",
    icon: <Wallet size={16} /> },
  { group: "Finance & Payments",
    title: "Asset depreciation report",
    blurb: "Fixed-asset register with cost, accumulated depreciation, and current book value by category.",
  ...
  { group: "Communications",
    ...
    blurb: "Upcoming events grouped by month, on the letterhead. Uses events from Website Studio.",
    href: "/dashboard/calendar/print",
    icon: <CalendarClock size={16} /> },
  { group: "Leadership",
    title: "Executive summary",
    blurb: "One-page KPI snapshot for the board — enrolment by grade, finance trend, attendance, academics.",
    href: "/dashboard/analytics/print",
    icon: <FileText size={16} /> },
  { group: "Hostel / Boarding",
    title: "House roster",
    blurb: "Bed-by-bed occupancy for a house with a Present column for evening roll call.",
    href: "/dashboard/hostel",
    needs: "Houses tab → printer icon",
    icon: <FileText size={16} /> },
  { group: "Students & Parents",
    title: "Welcome pack",
    blurb: "Admission letter + applicable fee schedule + calendar — three A4 pages, one PDF, ready to hand to a new family.",
    href: "/dashboard/students",
    needs: "Open a student → Welcome pack",
    icon: <UserPlus size={16} /> },
  { group: "Students & Parents",
    title: "Enrolment certificate",
    blurb: "Formal proof-of-enrolment letter — visa / scholarship / official use.",
    href: "/dashboard/students",
    needs: "Open a student → Enrolment certificate",
    icon: <UserPlus size={16} /> },
  { group: "Transport",
    title: "Route roster",
