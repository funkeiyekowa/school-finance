...
const roleTiles: Record<string, Tile[]> = {
  ...
  parent: [{ icon: "◉", label: "My children", detail: "Linked student information will appear here." }, { icon: "✓", label: "Attendance", detail: "View attendance for your child.", href: "/(app)/(tabs)/my-attendance" }, { icon: "₦", label: "Fees", detail: "Balances and payments will appear here." }],
