...
const roleTiles: Record<string, Tile[]> = {
  ...
  teacher: [{ icon: "▣", label: "My classes", detail: "Live classes you are authorised to capture attendance for." }, { icon: "✓", label: "Take attendance", detail: "Mark today's register for your classes.", href: "/(app)/(tabs)/attendance" }, { icon: "★", label: "Assessments", detail: "Exam and assessment tools are coming next." }],
