...
const roleTiles: Record<string, Tile[]> = {
  ...
  staff: [{ icon: "▣", label: "School workspace", detail: "Your authorised work will appear here." }, { icon: "✓", label: "Take attendance", detail: "Mark the register for a class.", href: "/(app)/(tabs)/attendance" }, { icon: "✉", label: "Messages", detail: "School messages are coming next." }],
...
export default function DashboardScreen() {
  ...
  const note = canCaptureAttendance(identity.role)
    ? "Attendance capture is live. Messages will be connected in a later mobile phase."
    : identity.role === "student"
      ? "Exams are live. Messages and your attendance overview will be connected in a later mobile phase."
      : "Messages and your attendance overview will be connected in a later mobile phase.";
