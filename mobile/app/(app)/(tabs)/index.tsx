...
export default function DashboardScreen() {
  ...
  const note = canCaptureAttendance(identity.role)
    ? "Attendance capture is live. Exams and messages will be connected in a later mobile phase."
    : "Exams, messages and your attendance overview will be connected in a later mobile phase.";
