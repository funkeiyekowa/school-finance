...
const roleTiles: Record<string, Tile[]> = {
  student: [{ icon: "▣", label: "My learning", detail: "Courses and classwork will appear here." }, { icon: "✓", label: "Attendance", detail: "Your attendance record and rate.", href: "/(app)/(tabs)/my-attendance" }, { icon: "★", label: "My exams", detail: "Sit your published exams and see results.", href: "/(app)/(tabs)/exams" }],
  parent: [{ icon: "◉", label: "My children", detail: "Linked student information will appear here." }, { icon: "✓", label: "Attendance", detail: "View attendance for your child.", href: "/(app)/(tabs)/my-attendance" }, { icon: "₦", label: "Fees", detail: "Balances and payments for your children.", href: "/(app)/(tabs)/my-fees" }],
