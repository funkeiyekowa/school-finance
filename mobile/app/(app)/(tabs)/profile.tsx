...
export default function ProfileScreen() {
  ...
  const leave = () => Alert.alert("Sign out?", "You will need to sign in again to access your school portal.", [{ text: "Cancel", style: "cancel" }, { text: "Sign out", style: "destructive", onPress: async () => { await signOut(); router.replace("/"); } }]);
